...
/**
 * struct passinfo - This contains pseudo-arguments passed into a function,
 * allowing uniform prototype for function pointer struct
 * @arg: a generated string from getline containing arguments
 ...
 * @status: the return of the last exec'd command
